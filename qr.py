    ...
    show_cc(
      ...
      for ig in g_mode:
        ...
        for max_cluster in cluster_scan:
          ...
          # calculator_manager.reset_fmodel(fmodel = start_fmodel)
          # calculator_manager.update_fmodel(fmodel = fmodel)
          grad.append(driver.run_gradient(calculator=calculator_manager,results=results_manager,xray_structure=model.xray_structure))
